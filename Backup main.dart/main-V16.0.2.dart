// Version 16.0.1 – SmartWake+ mit Alexa-Reminder über flutter_web_auth_2
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(onPressed: _testWeckton, child: const Text('Test')),
                _buildSwitchRow(
                    'Sprachsteuerung', _isVoiceControlEnabled, (v) {
  ...
  void _openAboutPopup() {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        backgroundColor: const Color(0xFF772625),
        title: const Text('Über SmartWake+',
            style: TextStyle(color: Colors.white)),
        content: const Text(
  ...
  Future<void> _scheduleAlexaReminder() async {
    ...
    try {
      final res = await http.post(
        Uri.parse('https://api.eu.amazonalexa.com/v1/alerts/reminders'),
        headers: {
    ...
    if (text.toLowerCase().contains(_triggerName.toLowerCase()) &&
      ...
      if (match != null) {
        ...
        if (_is24HourFormat || hour < 13) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text('Weckzeit gesetzt auf ${picked.format(context)}')),
          );
          if (_isAlexaEnabled && _alexaAccessToken != null) {
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  // Live-Uhrzeit
                  Text(_formattedTime, style: const TextStyle(fontSize: 65, color: Colors.white)),
                      ...
                      children: [
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(color: Colors.black.withOpacity(0.3), blurRadius: 8, offset: const Offset(0, 6)),
                              ],
                            ),
                        ...
                        if (_isListening)
                          Container(
                            ...
                            child: Text('Ich höre zu: $_recognizedText', style: const TextStyle(color: Colors.white)),
                          ),
                        const SizedBox(height: 30),
                      ],
                    ),
                  // Gesetzte Weckzeit anzeigen
                  if (_wakeTimeSet)
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: Colors.red,
                          boxShadow: [
                            if (_blink) const BoxShadow(color: Colors.white, blurRadius: 12, spreadRadius: 4)
                          ],
                        ),
                        child: const Icon(Icons.notifications_off, color: Colors.white, size: 48),
                      ),
                    ),
                ],
              ),
